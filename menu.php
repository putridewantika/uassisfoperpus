...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?page=utama">E - Library SMP Negeri 1 Mandoge</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <?php if (isset($_SESSION['level']) && $_SESSION['level'] == 1) { ?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="?page=buku&actions=report">Laporan Buku</a></li>
                ...
                <?php } else { ?>
                    <li><a href="?page=peminjaman&actions=tampil">History Peminjaman</a></li>
                <?php } ?>
