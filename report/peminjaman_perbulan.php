    ...
    <div class='row'>
      <div class="col-sm-12">
        ...
        <div class="text-center">
          ...
          <hr>
          <h3>DATA PEMINJAMAN BUKU BULAN <?= "$bulanNama $ambilthn"; ?></h3>
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $sql = "SELECT * FROM pinjam
                                    ...
                                    JOIN user ON pinjam.username_peminjam = user.username WHERE substr(pinjam.tgl_pinjam,1,7)='$ambilthn-$ambilbln'";
